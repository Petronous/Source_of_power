...
class LabelStack:
    ...
    def AddInfoLabel(name, stri, varToKeep, size = 18, color = (255,255,255,255), font = "Arial.ttf"):
        global menuSprites
    ...
    def AddSimpleButton(name, stri, size = 18, color = (255,255,255,255), font = "Arial.ttf", onClickFunction, funcArgsRefs):
        global menuButtons
